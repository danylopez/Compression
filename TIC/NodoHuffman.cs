...
{
    internal class NodoHuffman<T> : IComparable
    {
        internal NodoHuffman(double probabilidad, T valor)
        {
        ...
        internal NodoHuffman(NodoHuffman<T> leftSon, NodoHuffman<T> rightSon)
        {
            HijoIzq = leftSon;
            HijoDer = rightSon;
        ...
        internal NodoHuffman<T> HijoIzq { get; set; }
        internal NodoHuffman<T> HijoDer { get; set; }
        internal NodoHuffman<T> Padre { get; set; }
        ...
        {
            return -Probabilidad.CompareTo(((NodoHuffman<T>)obj).Probabilidad);
        }
    }
}
